...
function ChatPage() {
  ...
  return (
    <div className="w-full flex justify-center p-4 bg-transparent">
      ...
      <div className="relative w-full max-w-6xl md:h-[850px] h-[90dvh]">
        <BorderAnimatedContainer>  
          <div className="w-full h-full flex flex-col overflow-hidden">  
            ...
            <div className="w-full flex flex-1 flex-col md:flex-row overflow-hidden">      
              

              <div 
                className={`${selectedUser ? "hidden md:flex" : "flex"} 
                w-full md:w-80 flex flex-col 
                bg-[#131b2e]/60 backdrop-blur-sm 
                md:border-r border-[#464555]/20 
              ...
              <div 
                className={`${selectedUser ? "flex" : "hidden md:flex"} 
                flex-1 min-w-0 flex-col 
                bg-[#0b1326]/40 backdrop-blur-sm 
                overflow-hidden`}
              >      
